    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Update your name and contact details</p>
        </div>
      ...
      <CardContent className="flex flex-col gap-3">
        <p className="text-xs font-medium uppercase tracking-wide text-zinc-400 dark:text-zinc-500">Account Details</p>
        ...
        <div className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-800/50">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100">{ROLE_LABEL[user.role_id] ?? 'Unknown'}</p>
          </div>
        </div>
        <p className="mt-2 text-xs font-medium uppercase tracking-wide text-zinc-400 dark:text-zinc-500">Personal Information</p>
        <div className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-800/50">
      ...
      <EditMyInfoDialog user={user} open={editOpen} onOpenChange={setEditOpen} />
    </Card>
  )
}