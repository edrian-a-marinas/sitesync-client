...
export const createAttendanceRequest = (projectId: number, logId: number, data: AttendanceCreate) =>
  api.post(`/projects/${projectId}/daily-logs/${logId}/attendance`, data)

export const getMyAttendanceHistoryRequest = (projectId: number, page: number, limit: number) =>
  api.get(`/projects/${projectId}/daily-logs/attendance/me`, { params: { page, limit } })