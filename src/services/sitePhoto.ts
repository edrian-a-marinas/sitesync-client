import { deleteSitePhotoRequest, getSitePhotosRequest, uploadSitePhotoRequest } from '@/api/sitePhoto'
...
export const deleteSitePhoto = async (projectId: number, logId: number, photoId: number): Promise<void> => {
